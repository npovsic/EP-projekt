    ...
    <div class="wrapper">
        <div class="row active-with-click text-center">
            <form class="login_form" method="post" action="<?php echo ADMIN_URL."edit/".$variables['id_seller'] ?>">
                ...
                <label class="align-left">Geslo<br><input class="input-modern" type="password" name="password" value="<?php echo $variables['password'] ?>" ></label><br>
                ...
                <label class="align-left">Elektronska pošta<br><input class="input-modern" type="text" name="email" value="<?php echo $variables['email'] ?>" ></label><br>
                ...
                <label class="align-left">Aktiven<br><input class="input-modern" type="text" name="active" value="<?php echo $variables['active'] ?>" ></label><br>
